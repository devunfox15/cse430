...
updateNameButton === null || updateNameButton === void 0 ? void 0 : updateNameButton.addEventListener('click', function () {
    if (userNameInput === null || userNameInput === void 0 ? void 0 : userNameInput.value) {
        ...
        if (dynamicMessage) {
            dynamicMessage.textContent = "Hey, ".concat(enteredName, ", You seem cool. Connect with me on LinkedIn!");
            if (keyWordsElement) {
